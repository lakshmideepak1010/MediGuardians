            ...
            children: [
                      ...
                      StreamBuilder<List<InventoryRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children:
                                List.generate(columnInventoryRecordList.length,
                                    (columnIndex) {
                              ...
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    5.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  columnInventoryRecord.productId,
                            ...
                            children:
                              ...
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    5.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  columnInventoryRecord.amount.toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.plusJakartaSans(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Column(
                        ...
                        children: List.generate(
                            columnInventoryRecordList.length, (columnIndex) {
                          final columnInventoryRecord =
                              columnInventoryRecordList[columnIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
              ...
              StreamBuilder<List<InventoryRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    mainAxisSize: MainAxisSize.max,
                    children: List.generate(columnInventoryRecordList.length,
                        (columnIndex) {
                      final columnInventoryRecord =
                          columnInventoryRecordList[columnIndex];
                      return Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            columnInventoryRecord.expdate?.toString(),
                            'exp',
                          ),
                          style:
