            ...
            children: [
                    ...
                    children: [
                      StreamBuilder<List<TrackorderRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children:
                                List.generate(columnTrackorderRecordList.length,
                                    (columnIndex) {
                              final columnTrackorderRecord =
                                  columnTrackorderRecordList[columnIndex];
                              return Text(
                                valueOrDefault<String>(
                                  columnTrackorderRecord.orderid.toString(),
                                  'orid',
                                ),
                      ...
                      FutureBuilder<ApiCallResponse>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final columnDataResponse = snapshot.data!;

                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              Text(
                                columnDataResponse.succeeded.toString(),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.plusJakartaSans(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Column(
                        ...
                        children: List.generate(
                            columnTrackorderRecordList.length, (columnIndex) {
                          final columnTrackorderRecord =
                              columnTrackorderRecordList[columnIndex];
                          return Text(
                            columnTrackorderRecord.amount.toString(),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.plusJakartaSans(
              ...
              StreamBuilder<List<TrackorderRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    mainAxisSize: MainAxisSize.max,
                    children: List.generate(columnTrackorderRecordList.length,
                        (columnIndex) {
                      final columnTrackorderRecord =
                          columnTrackorderRecordList[columnIndex];
                      return Text(
                        valueOrDefault<String>(
                          columnTrackorderRecord.deleverdate?.toString(),
                          'delv',
                        ),
