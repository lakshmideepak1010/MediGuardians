        ...
        body: SafeArea(
          ...
          child: StreamBuilder<List<AlertsRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<AlertsRecord> columnAlertsRecordList = snapshot.data!;

              return Column(
                mainAxisSize: MainAxisSize.max,
                children:
                    List.generate(columnAlertsRecordList.length, (columnIndex) {
                  final columnAlertsRecord =
                      columnAlertsRecordList[columnIndex];
                  return Container(
